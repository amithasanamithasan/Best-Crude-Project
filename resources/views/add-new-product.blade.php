...
@endif
            ...
            <div class="form-group mb-3">
                ...
                <input style="height:100px width:50px"  name="address"    type="text" class="form-control" placeholder="Input Address" required>
            </div>
            <div class="form-group mb-3">
                <label>Phone</label>
                <input type="text"  name="number" class="form-control"placeholder="Phonenumber" required>
            </div>
            <div class="form-group mb-3">
                <label>Image</label>
