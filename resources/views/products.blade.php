...
<div class="row">
<div class="col-sm-6">
<h2>Manage <b>Products List</b></h2>
</div>
<div class="col-sm-6">
...
<div style=" float:right " ;>
    {{-- <a class="btn btn dark" href="{{route('add.product')}}"> </a> --}}
    <a style="background: #660746 "href="{{route('add.product')}}"><button style="height: 20px wide:10px  ">ADD NEW PRODUCTS</button></a>
                    </div>
					</div>
				</div>
			</div>
    ...
    <label for="checkbox1"></label> 
        ...
        <td>
         {{-- <a href="{{route('edit.product')}}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a> --}}
         {{-- <li class="list-inline-item">
           <a href="{{route('edit.product')}}" ><button class="btn btn-success btn-sm rounded-0"  title="Edit"><i class="fa fa-edit"></i></button>
           </li></a>  --}}
           <p>
